...
import type { Api, Context, Model, StreamOptions, Usage } from "lonhu/llm/types";
...
describe("totalTokens field", () => {
  ...
  describe.skipIf(!process.env.ZAI_API_KEY)("z.ai", () => {
    it("glm-4.5-flash - should return totalTokens equal to sum of components", {
      retry: 3,
      timeout: 60000,
    }, async () => {
  ...
  describe.skipIf(!process.env.OPENROUTER_API_KEY)("OpenRouter", () => {
    ...
    it("google/gemini-2.0-flash-001 - should return totalTokens equal to sum of components", {
      retry: 3,
      timeout: 60000,
    }, async () => {
    ...
    it("meta-llama/llama-4-scout - should return totalTokens equal to sum of components", {
      retry: 3,
      timeout: 60000,
    }, async () => {
