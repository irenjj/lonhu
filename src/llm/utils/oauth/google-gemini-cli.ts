...
const CLIENT_ID = decode(
  ["NjgxMjU1ODA5Mzk1LW9vOGZ0Mm9wcmRybnA5ZTNh", "cWY2YXYzaG1kaWIxMzVqLmFwcHMuZ29vZ2xldXNl", "cmNvbnRlbnQuY29t"].join(""),
);
const CLIENT_SECRET = decode(["R09DU1BYLTR1SGdN", "UG0tMW83U2stZ2VW", "NkN1NWNsWEZzeGw="].join(""));
